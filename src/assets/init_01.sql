...
('Design homepage', 'Create a responsive design for the homepage.', 'Feature', 'In Progress', NOW() - INTERVAL '5 days'),
...
('Update dependencies', 'Upgrade outdated libraries and packages.', 'Maintenance', 'In Progress', NOW() - INTERVAL '8 days');
